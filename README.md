...
3. Before proceeding to raw reads, the database must be validated (using the WW_Genotyper-v2_Validation.rmd). This R script requires partial sequences of the desired target. Similarly, these sequence names must also be standardized to match the genotype names in the consensus sequence database. 
